        ...
        xhr.onreadystatechange = function () {
            ...
            if (this.status == 200) {
                ...
                if (this.responseText.length == 0){
                    ...
                    var ret = _self.frameInfo.anno_to_boxes(this.responseText);

                    ret = _self.transformBoxesByOffset(ret);
                ...
                console.log(_self.boxes_load_time, _self.frameInfo.scene, _self.frameInfo.frame, "loaded boxes ", _self.boxes_load_time - _self.create_time, "ms");
            ...
            return annotations.map(function(b){
                ...
                mesh.getTruePosition = function(){
                    return {
                        ...
                        y: this.position.y - _self.coordinatesOffset[1],
                        z: this.position.z - _self.coordinatesOffset[2]
                    };
                };
...
function Data(metaData){
    ...
    this.make_new_world = function(scene_name, frame, on_preload_finished){
        return new World(this, scene_name, frame, [200,100,0], on_preload_finished);        
    };
