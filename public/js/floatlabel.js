...
class FastToolBox {
  ...
  setValue(obj_type, obj_track_id, obj_attr) {
    ...
    if (obj_attr) this.ui.querySelector("#attr-input").value = obj_attr;
    else this.ui.querySelector("#attr-input").value = "";
  }
  ...
  setAttrOptions(obj_type, obj_attr) {
    ...
    if (
      globalObjectCategory.obj_type_map[obj_type] &&
  ...
  installEventHandler() {
    ...
    this.ui.querySelector("#attr-input").onchange = (event) =>
      this.eventHandler(event);
    this.ui
