...
class PointCloudReader
{
  ...
  parsePcd( data, url) {
    ...
    if ( PCDheader.data === 'binary_compressed' ) {
        ...
        var decompressed = this.decompressLZF( new Uint8Array( data, PCDheader.headerLen + 8, compressedSize ), decompressedSize );
...
let pointcloudReader = new PointCloudReader();
