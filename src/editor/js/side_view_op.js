    ...
    on_key_down(event){
        ...
        switch(event.key){
            case 'e':
                event.preventDefault();
                event.stopPropagation();
                this.on_direction_changed(-this.getRotateStep(event), event.ctrlKey);
            ...
            case 'f':
                event.preventDefault();
                event.stopPropagation();
                this.on_direction_changed(-this.getRotateStep(event), true);
                this.hide_buttons(true);
                break;
            case 'r':                
                event.preventDefault();
            ...
            case 'ArrowUp':
                event.preventDefault();
                event.stopPropagation();
                this.on_moved({x:0, y: this.getMoveStep(event)});
                this.hide_buttons(true);
                break;
            case 's':
                if (!event.ctrlKey){
            ...
            case 'ArrowLeft':
                event.preventDefault();
                event.stopPropagation();
                this.on_moved({x:-this.getMoveStep(event), y:0});
                this.hide_buttons(true);
                break;
            case 'd':
                if (event.ctrlKey){
