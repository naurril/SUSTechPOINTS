...
class CalibTool  extends PopupDialog{
    ...
    constructor(ui, editor)
    {
        ...
        this.ui.querySelector("#btn-apply-settings").onclick = ()=>{
            let rotateStep = this.ui.querySelector("#rotate-step").value;
            let translateStep = this.ui.querySelector("#translate-step").value;
    ...
    start(){
        ...
        let [cameraType, cameraName] = targetName.split(":");
